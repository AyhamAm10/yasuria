...
export const addCarSchema = (lang: string) =>
  Yup.object().shape({
    title_ar: Yup.string()
      .required(ErrorMessages.generateErrorMessage("العنوان العربي", "required", lang))
      .min(3, ErrorMessages.generateErrorMessage("العنوان العربي", "min", lang)),
    ...
    desc_ar: Yup.string()
      .required(ErrorMessages.generateErrorMessage("الوصف العربي", "required", lang))
    ...
    location: Yup.string()
      .required(ErrorMessages.generateErrorMessage("الموقع", "required", lang)),
      
    lat: Yup.number()
      .nullable()
      .typeError(ErrorMessages.generateErrorMessage("خط العرض", "invalid", lang))
    ...
    long: Yup.number()
      .nullable()
      .typeError(ErrorMessages.generateErrorMessage("خط الطول", "invalid", lang))
      .when('lat', (lat, schema) => 
    ...
    listing_type: Yup.string()
      .required(ErrorMessages.generateErrorMessage("نوع القائمة", "required", lang))
      .oneOf(
        ["sale", "rent"],
